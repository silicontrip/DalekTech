...
public class GreyRenegadeTactical extends TacticalUI {
	...
	public WeaponUI getRightShoulder() { return new WeaponUI ("Plunger",0,1, 0, 2, 6, 6, 6,Guitwo.getImageWithFilename("Images/GreyPlunger.png")); } 
	public WeaponUI getLeftShoulder() { return new WeaponUI ("Mediam Laser",0,3, 6, 9, 5, 5, 5,Guitwo.getImageWithFilename("Images/GreyLaser.png")); } 
