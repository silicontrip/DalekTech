...
public class ImperialTactical extends TacticalUI {
	...
	public ImperialTactical() throws FileNotFoundException {
		super(4);
	}

	public WeaponUI getDome() { return null; }
	public WeaponUI getNeck() { return null; }
	public WeaponUI getRightShoulder() throws FileNotFoundException  { return new WeaponUI("Plunger",0,1, 0, 2, 6, 6, 6,getImageWithFilename("Images/ImperialPlunger.png")); } 
	public WeaponUI getLeftShoulder()  throws FileNotFoundException { return new WeaponUI("Medium Laser",0,3, 6, 9, 5, 5, 5,getImageWithFilename("Images/ImperialLaser.png")); }
