...
public class ImperialTactical extends TacticalUI {
	...
	public WeaponUI getRightShoulder() { return new WeaponUI("Plunger",0,1, 0, 2, 6, 6, 6,getImageWithFilename("Images/ImperialPlunger.png")); } 
	public WeaponUI getLeftShoulder() { return new WeaponUI("Medium Laser",0,3, 6, 9, 5, 5, 5,getImageWithFilename("Images/ImperialLaser.png")); }
